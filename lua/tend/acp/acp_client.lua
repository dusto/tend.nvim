...
local transport_module = require("tend.acp.acp_transport")
...
--- @class tend.acp.ACPClientData
--- @field provider_config tend.acp.ACPProviderConfig
--- @field id_counter number
--- @field state tend.acp.ClientConnectionState
--- @field protocol_version number
--- @field client_info tend.acp.ClientInfo
--- @field capabilities tend.acp.ClientCapabilities
--- @field agent_capabilities? tend.acp.AgentCapabilities
--- @field agent_info? tend.acp.AgentInfo
--- @field auth_methods tend.acp.AuthMethod[]
--- @field callbacks table<number, fun(result: table|nil, err: tend.acp.ACPError|nil)>
--- @field transport? tend.acp.ACPTransportInstance
--- @field ready_listeners fun(client: tend.acp.ACPClient)[]
--- @field subscribers table<string, tend.acp.ClientHandlers>

--- @class tend.acp.ACPClient : tend.acp.ACPClientData
--- @field _on_ready fun(client: tend.acp.ACPClient)
local ACPClient = {}
...
--- @param config tend.acp.ACPProviderConfig
--- @param on_ready fun(client: tend.acp.ACPClient)
--- @return tend.acp.ACPClient client
function ACPClient:new(config, on_ready)
    --- @type tend.acp.ACPClientData
    local instance = {
    ...
    local client = setmetatable(instance, self) --[[@as tend.acp.ACPClient]]
...
--- @param callback fun(client: tend.acp.ACPClient)
...
--- @param handlers tend.acp.ClientHandlers
...
--- @protected
--- @param session_id string
--- @param callback fun(sub: tend.acp.ClientHandlers): nil
...
function ACPClient:_setup_transport()
    ...
    if transport_type == "stdio" then
        --- @type tend.acp.StdioTransportConfig
        ...
        --- @type tend.acp.TransportCallbacks
        local callbacks = {
...
--- @param state tend.acp.ClientConnectionState
...
--- @param data any|nil
--- @return tend.acp.ACPError error
...
--- @param callback fun(result: table|nil, err: tend.acp.ACPError|nil)
...
--- @param message tend.acp.ResponseRaw
        ...
        if not KNOWN_ACP_KINDS[update.kind] then
            ...
            Logger.notify(
                "Unknown ACP tool call kind: "
                    ...
                    .. "https://github.com/dusto/tend.nvim/issues/new",
                vim.log.levels.WARN
            )
        end
...
--- @protected
--- @param update tend.acp.ToolCallBase
--- @return tend.ui.MessageWriter.ToolCallBlock message
function ACPClient:__build_tool_call_message(update)
    --- @type tend.ui.MessageWriter.ToolCallBlock
    local message = {
...
--- @protected
--- @param session_id string
--- @param update tend.acp.ToolCallMessage
...
--- @protected
--- @param session_id string
--- @param update tend.acp.ToolCallUpdate
...
function ACPClient:__handle_request_permission(message_id, request)
    ...
    self:__with_subscriber(session_id, function(subscriber)
        ...
        subscriber.on_request_permission(request, function(option_id)
            --- @type tend.acp.RequestPermissionOutcome
...
function ACPClient:_connect()
    ...
    --- @type tend.acp.InitializeParams
    local init_params = {
    ...
    self:_send_request("initialize", init_params, function(result, err)
        ...
        --- @cast result tend.acp.InitializeResponse
...
--- @param handlers tend.acp.ClientHandlers
--- @param callback fun(result: tend.acp.SessionCreationResponse|nil, err: tend.acp.ACPError|nil)
function ACPClient:create_session(handlers, callback)
    ...
    self:_send_request("session/new", {
        ...
        --- @cast result tend.acp.SessionCreationResponse
        callback(result, nil)
    end)
end
...
--- @param handlers tend.acp.ClientHandlers
--- @param on_load_complete fun(err: tend.acp.ACPError|nil)|nil
...
--- @param cwd string
--- @param callback fun(result: tend.acp.SessionListResponse|nil, err: tend.acp.ACPError|nil)
function ACPClient:list_sessions(cwd, callback)
    ...
    self:_send_request("session/list", {
        ...
        --- @cast result tend.acp.SessionListResponse
        callback(result, nil)
    end)
end

--- @param session_id string
--- @param prompt tend.acp.Content[]
--- @param callback fun(result: table|nil, err: tend.acp.ACPError|nil)
