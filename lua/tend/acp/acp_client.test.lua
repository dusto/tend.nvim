...
describe("ACPClient", function()
    ...
    --- @type fun(state: tend.acp.ClientConnectionState)|nil
    local captured_on_state_change

    --- @type fun(message: tend.acp.ResponseRaw)|nil
    ...
    --- @param agent_caps tend.acp.AgentCapabilities|nil
    ...
    --- @param _client tend.acp.ACPClient
    --- @param method string
    --- @param response_result table|nil
    --- @param response_err tend.acp.ACPError|nil
    ...
    before_each(function()
        package.loaded["tend.acp.acp_client"] = nil
        package.loaded["tend.acp.acp_transport"] = nil
        ...
        ACPClient = require("tend.acp.acp_client")
    end)
    ...
    describe("list_sessions", function()
        ...
        it("callback receives SessionListResponse on success", function()
            ...
            --- @type tend.acp.SessionListResponse|nil
            local received_result
            --- @type tend.acp.ACPError|nil
            local received_err
            ...
            --- @cast received_result tend.acp.SessionListResponse
        ...
        it("callback receives error on failure", function()
            ...
            --- @cast received_err tend.acp.ACPError
    ...
    describe("_drain_pending_callbacks", function()
        ...
        it("calls pending callbacks with error when disconnected", function()
            ...
            --- @cast captured_on_state_change fun(state: tend.acp.ClientConnectionState)
