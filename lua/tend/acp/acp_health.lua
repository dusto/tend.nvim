...
--- @return tend.UserConfig.ProviderName[] provider_names
...
function ACPHealth.check_configured_provider()
    ...
    elseif not ACPHealth.is_command_available(provider_config.command) then
        vim.list_extend(lines, {
            ...
            "",
            "- If it's the first time you're using Tend.nvim, you might have **NEVER** installed it",
            "",
    ...
    vim.list_extend(lines, {
        ...
        "",
        "https://github.com/dusto/tend.nvim?tab=readme-ov-file#-requirements",
        "",
        "**PLEASE NOTE**: Tend.nvim does NOT install any ACP providers on your behalf, for security and privacy reasons.",
        "",
        "Run `:checkhealth tend` for more information.",
    })

    -- Build final message with header, error content, and footer
    local merged_lines = {
        "# Welcome to Tend.nvim!",
        "",
