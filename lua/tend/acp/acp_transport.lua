...
--- @alias tend.acp.TransportType "stdio" | "tcp" | "websocket"

--- @class tend.acp.ACPTransportModule
local M = {}

--- @class tend.acp.TransportCallbacks
--- @field on_state_change fun(state: tend.acp.ClientConnectionState): nil The transport state like "connecting", "connected", "disconnected", "error"
--- @field on_message fun(message: tend.acp.ResponseRaw): nil
--- @field on_reconnect fun(): nil

--- @class tend.acp.StdioTransportConfig
...
function M.create_stdio_transport(config, callbacks)
    ...
    --- @class tend.acp.ACPTransportInstance
    local transport = {
