...
-- because its `setup()` mocks `tend.acp.acp_transport`; here we need the
-- real module to spawn a real process.
--
-- This is the canonical exception to the "MUST stub `tend.acp.acp_transport`"
    ...
    it(
        ...
        function()
            ...
            local got_pid = child.lua([[
                local Transport = require("tend.acp.acp_transport")
                _G.t = {}
