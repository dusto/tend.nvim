...
local List = require("tend.utils.list")
...
--- @class tend.acp.AgentConfigOptions
--- @field mode? tend.acp.ConfigOption
--- @field model? tend.acp.ConfigOption
--- @field thought_level? tend.acp.ConfigOption
--- @field legacy_agent_modes tend.acp.AgentModes
--- @field legacy_agent_models tend.acp.AgentModels
local AgentConfigOptions = {}
AgentConfigOptions.__index = AgentConfigOptions

--- @class tend.acp.AgentConfigOptions.Callbacks
...
--- @param buffers tend.ui.ChatWidget.BufNrs Same buffers as ChatWidget instance
--- @param callbacks tend.acp.AgentConfigOptions.Callbacks
--- @return tend.acp.AgentConfigOptions
function AgentConfigOptions:new(buffers, callbacks)
    local AgentModes = require("tend.acp.agent_modes")
    local AgentModels = require("tend.acp.agent_models")
    ...
    for _, bufnr in pairs(buffers) do
        ...
        BufHelpers.multi_keymap_set(
            ...
            { desc = "Tend: Select Thought Effort Level" }
        )
    end
...
--- @param configOptions tend.acp.ConfigOption[]|nil
...
--- @param modes_info tend.acp.ModesInfo
...
--- @param models_info tend.acp.ModelsInfo
...
--- @param target tend.acp.ConfigOption|nil
--- @param value string
--- @return tend.acp.ConfigOption.Option|nil
...
function AgentConfigOptions:_show_selector(target, prompt, handle_change)
    ...
    vim.ui.select(ordered_options, {
        ...
        format_item = function(item)
            --- @cast item tend.acp.ConfigOption.Option -- need to cast because `select` has a Generic, but not for `format_item`
