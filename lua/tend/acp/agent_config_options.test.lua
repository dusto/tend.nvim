...
describe("tend.acp.AgentConfigOptions", function()
    --- @type tend.acp.AgentConfigOptions
    ...
    before_each(function()
        ...
        AgentConfigOptions = require("tend.acp.agent_config_options")
    ...
    for _, case in ipairs({
        ...
        describe(case.method, function()
            ...
            before_each(function()
                config_options:set_options({ case.option })
                notify_stub = spy.stub(require("tend.utils.logger"), "notify")
            end)
    ...
    for _, case in ipairs({
        ...
        describe(case.method, function()
            ...
            it(
                ...
                function()
                    local notify_stub =
                        spy.stub(require("tend.utils.logger"), "notify")
    ...
    describe("show_thought_level_selector", function()
        ...
        it("returns false and notifies when thought_level is unset", function()
            local notify_stub = spy.stub(require("tend.utils.logger"), "notify")
