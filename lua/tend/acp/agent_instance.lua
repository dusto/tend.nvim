...
local ACPClient = require("tend.acp.acp_client")

--- @class tend.acp.AgentInstance
--- @field chat_widget tend.ui.ChatWidget
--- @field agent_client tend.acp.ACPClient
...
--- @private
--- @type table<tend.UserConfig.ProviderName, tend.acp.ACPClient|nil>
