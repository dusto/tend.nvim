...
--- @class tend.acp.AgentModels
--- @field _models tend.acp.Model[]
--- @field current_model_id? string
local AgentModels = {}
AgentModels.__index = AgentModels

--- @return tend.acp.AgentModels
...
--- @return { models: tend.acp.Model[], current_model_id: string|nil } snapshot
...
--- @param snapshot { models: tend.acp.Model[], current_model_id: string|nil }
