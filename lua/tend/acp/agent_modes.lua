...
--- @class tend.acp.AgentModes
--- @field _modes tend.acp.AgentMode[]
--- @field current_mode_id? string
local AgentModes = {}
AgentModes.__index = AgentModes

--- @return tend.acp.AgentModes
...
function AgentModes:show_mode_selector(set_mode_callback)
    ...
    vim.ui.select(self._modes, {
        ...
        format_item = function(item)
            --- @cast item tend.acp.AgentMode -- need to cast because `select` has a Generic, but not for `format_item`
...
--- @return { modes: tend.acp.AgentMode[], current_mode_id: string|nil }
...
--- @param snapshot { modes: tend.acp.AgentMode[], current_mode_id: string|nil }
