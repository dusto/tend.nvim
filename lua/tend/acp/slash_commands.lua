local States = require("tend.states")
...
--- @param bufnr integer
--- @param available_commands tend.acp.AvailableCommand[]
function SlashCommands.setCommands(bufnr, available_commands)
    --- @type tend.acp.CompletionItem[]
    local commands = {}
...
function SlashCommands.setup_completion(bufnr)
    ...
    vim.bo[bufnr].completefunc =
        "v:lua.require'tend.acp.slash_commands'.complete_func"
