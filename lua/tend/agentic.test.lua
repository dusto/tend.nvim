...
describe("tend: switch_provider", function()
    --- @type TestStub
    ...
    it("restores chat history messages after switching provider", function()
        ...
        } --[[@as tend.ui.ChatHistory.Message]]
        ...
        Tend.switch_provider({ provider = "NewProvider" })
        flush_schedule()
        ...
        -- Get new session
        local new_session = SessionRegistry.sessions[tab_page_id] --[[@as tend.SessionManager]]
    ...
    it("blocks switch when session is initializing", function()
        ...
        -- Try to switch
        Tend.switch_provider({ provider = "TestProvider" })
    ...
    it(
        ...
        function()
            ...
            local session1 = SessionManager:new(tab1_id) --[[@as tend.SessionManager]]
            flush_schedule()
            ...
            local session2 = SessionManager:new(tab2_id) --[[@as tend.SessionManager]]
            flush_schedule()
            ...
            Tend.switch_provider({ provider = "SwitchedProvider" })
            flush_schedule()
            ...
            local new_session1 = SessionRegistry.sessions[tab1_id] --[[@as tend.SessionManager]]
            ...
            local current_session2 = SessionRegistry.sessions[tab2_id] --[[@as tend.SessionManager]]
