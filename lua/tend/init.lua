...
local SessionRestore = require("tend.session_restore")
...
--- @param opts tend.ui.ChatWidget.AddToContextOpts|nil
function Tend.add_selection(opts)
    SessionRegistry.get_session_for_tab_page(nil, function(session)
...
--- @param opts tend.ui.ChatWidget.AddFilesToContextOpts
...
--- @param opts tend.ui.ChatWidget.AddToContextOpts|nil
function Tend.add_selection_or_file_to_context(opts)
    SessionRegistry.get_session_for_tab_page(nil, function(session)
        session:add_selection_or_file_to_session()
        session.widget:show(opts)
    end)
...
--- @param opts tend.ui.ChatWidget.AddToContextOpts|nil
function Tend.add_buffer_diagnostics(opts)
    SessionRegistry.get_session_for_tab_page(nil, function(session)
...
--- @param opts tend.ui.NewSessionOpts|nil
function Tend.new_session(opts)
...
--- @param opts tend.ui.ChatWidget.ShowOpts|nil
function Tend.new_session_with_provider(opts)
    SessionRegistry.select_provider(function(provider_name)
        if provider_name then
            local merged_opts = vim.tbl_deep_extend("force", opts or {}, {
                provider = provider_name,
            }) --[[@as tend.ui.NewSessionOpts]]

            Tend.new_session(merged_opts)
        end
    end)
end

--- @class tend.ui.SwitchProviderOpts
--- @field provider? tend.UserConfig.ProviderName

--- @param provider_name tend.UserConfig.ProviderName
...
--- @param opts tend.ui.SwitchProviderOpts|nil
function Tend.switch_provider(opts)
    if opts and opts.provider then
...
function Tend.setup(opts)
    ...
    vim.api.nvim_create_autocmd("VimLeavePre", {
        ...
        desc = "Cleanup Tend processes on exit",
    })
