...
describe("tend.SessionManager", function()
    ...
    describe("_on_session_update: config_option_update", function()
        ...
        it("sets config options and updates header on mode", function()
            --- @type tend.acp.ConfigOptionsUpdate
            local update = {
    ...
    describe("_generate_welcome_header", function()
        it(
            ...
            function()
                ...
                assert.truthy(header:match("^# Tend %- Claude ACP\n"))
        ...
        it("includes version when provided", function()
            ...
            assert.truthy(header:match("^# Tend %- Claude ACP v1%.2%.3\n"))
            assert.truthy(header:match("\n%- session id: abc123\n"))
        end)
    ...
    describe("can_submit_prompt", function()
        ...
        after_each(function()
            ...
            local SessionRegistry = require("tend.session_registry")
            local tab_ids = {}
        ...
        it("returns false when connection error occurred", function()
            ...
            local session = SessionManager:new(tab_page_id) --[[@as tend.SessionManager]]
            flush_schedule()
    ...
    describe("history_to_send consumption", function()
        ...
        it("prepends history on first submit and clears it", function()
            ...
            --- @type tend.ui.ChatHistory.Message[]
            local history = {
                {
                    type = "user",
                    text = "old msg",
    ...
    describe("on_tool_call_update: buffer reload", function()
        ...
        it(
            ...
            function()
                ...
                local unloaded_path = "/tmp/tend-unloaded-"
    ...
    describe("new_session: on_create_session_response hook", function()
        ...
        --- @param session tend.SessionManager
        --- @param response tend.acp.SessionCreationResponse|nil
        --- @param err tend.acp.ACPError|nil
        ...
        it("fires on error with err set and response nil", function()
            ...
            fake_create_session(session, nil, err --[[@as tend.acp.ACPError]])
    ...
    describe("initial thought_level wiring", function()
        ...
        it(
            ...
            function()
                local tab_page_id = vim.api.nvim_get_current_tabpage()
                local _session = SessionManager:new(tab_page_id) --[[@as tend.SessionManager]]
                flush_schedule()
