...
describe("tend.SessionRegistry", function()
    --- @type tend.SessionRegistry
    ...
    local original_loaded = {
        ["tend.config"] = package.loaded["tend.config"],
        ["tend.config_default"] = package.loaded["tend.config_default"],
        ["tend.acp.acp_health"] = package.loaded["tend.acp.acp_health"],
        ["tend.utils.logger"] = package.loaded["tend.utils.logger"],
        ["tend.session_manager"] = package.loaded["tend.session_manager"],
        ["tend.session_registry"] = package.loaded["tend.session_registry"],
    }

    package.loaded["tend.config"] = config_mock
    package.loaded["tend.config_default"] = default_config_mock
    package.loaded["tend.acp.acp_health"] = acp_health_mock
    package.loaded["tend.utils.logger"] = logger_stub
    package.loaded["tend.session_manager"] = session_manager_mock
    package.loaded["tend.session_registry"] = nil

    SessionRegistry = require("tend.session_registry")
    ...
    after_each(function()
        ...
        package.loaded["tend.session_manager"] =
            original_loaded["tend.session_manager"]
        package.loaded["tend.config"] = original_loaded["tend.config"]
        package.loaded["tend.config_default"] =
            original_loaded["tend.config_default"]
        package.loaded["tend.acp.acp_health"] =
            original_loaded["tend.acp.acp_health"]
        package.loaded["tend.utils.logger"] =
            original_loaded["tend.utils.logger"]
