...
describe("SessionRestore", function()
    ...
    before_each(function()
        package.loaded["tend.session_restore"] = nil
        package.loaded["tend.utils.logger"] = nil

        SessionRestore = require("tend.session_restore")
        Logger = require("tend.utils.logger")
    ...
    describe("conflict detection", function()
        ...
        it("detects no conflict when session has no messages", function()
            ...
            SessionRestore.show_picker(session --[[@as tend.SessionManager]])
        ...
        it(
            ...
            function()
                ...
                SessionRestore.restore_by_id(
                    session --[[@as tend.SessionManager]],
                    "abc-123"
                )
