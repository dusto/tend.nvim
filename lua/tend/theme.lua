...
--- @alias tend.Theme.SpinnerState "generating" | "thinking" | "searching" | "busy"

--- @class tend.Theme
local Theme = {}

Theme.HL_GROUPS = {
    DIFF_DELETE = "TendDiffDelete",
    DIFF_ADD = "TendDiffAdd",
    DIFF_DELETE_WORD = "TendDiffDeleteWord",
    DIFF_ADD_WORD = "TendDiffAddWord",
    STATUS_PENDING = "TendStatusPending",
    STATUS_COMPLETED = "TendStatusCompleted",
    STATUS_FAILED = "TendStatusFailed",
    CODE_BLOCK_FENCE = "TendCodeBlockFence",
    WIN_BAR_TITLE = "TendTitle",

    PERMISSION_BUTTON_ALLOW = "TendPermissionButtonAllow",
    PERMISSION_BUTTON_REJECT = "TendPermissionButtonReject",
    PERMISSION_BUTTON_INACTIVE = "TendPermissionButtonInactive",

    SPINNER_GENERATING = "TendSpinnerGenerating",
    SPINNER_THINKING = "TendSpinnerThinking",
    SPINNER_SEARCHING = "TendSpinnerSearching",
    SPINNER_BUSY = "TendSpinnerBusy",
    THINKING = "TendThinking",
}
...
function Theme.setup()
    ...
    local highlights = {
        ...
        { Theme.HL_GROUPS.THINKING, { link = "Comment" } },
    }
    -- stylua: ignore end
