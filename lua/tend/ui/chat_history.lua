--- @class tend.ui.ChatHistory.UserMessage
--- @field type "user"
...
--- @class tend.ui.ChatHistory.AgentMessage
--- @field type "agent"
--- @field provider_name string
--- @field text string Agent response text (concatenated chunks)

--- @class tend.ui.ChatHistory.ThoughtMessage : tend.ui.ChatHistory.AgentMessage
--- @field type "thought"

--- @class tend.ui.ChatHistory.ToolCall : tend.ui.MessageWriter.ToolCallBlock
--- @field tool_call_id? string
--- @field type "tool_call"

--- @alias tend.ui.ChatHistory.Message
--- | tend.ui.ChatHistory.UserMessage
--- | tend.ui.ChatHistory.AgentMessage
--- | tend.ui.ChatHistory.ThoughtMessage
--- | tend.ui.ChatHistory.ToolCall

--- @class tend.ui.ChatHistory
--- @field session_id? string
--- @field timestamp integer Unix timestamp when session was created
--- @field messages tend.ui.ChatHistory.Message[]
--- @field title string
local ChatHistory = {}
ChatHistory.__index = ChatHistory

--- @return tend.ui.ChatHistory
function ChatHistory:new()
    --- @type tend.ui.ChatHistory
    local instance = {
        session_id = nil,
        timestamp = os.time(),
        messages = {},
...
--- @param msg tend.ui.ChatHistory.Message
...
--- @param update tend.ui.ChatHistory.ToolCall
