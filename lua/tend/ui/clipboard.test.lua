...
describe("Clipboard", function()
    ...
    before_each(function()
        package.loaded["tend.ui.clipboard"] = nil
        original_clipboard_image = package.loaded["tend.ui.clipboard_image"]
        original_floating_message = package.loaded["tend.ui.floating_message"]
        show_spy = spy.new()

        package.loaded["tend.ui.floating_message"] = {
            show = show_spy,
        }
    end)
    ...
    after_each(function()
        ...
        package.loaded["tend.ui.floating_message"] = original_floating_message
    end)
    ...
    local function load_with_platform(platform)
        ...
        Clipboard = require("tend.ui.clipboard")
    end
