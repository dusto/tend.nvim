...
describe("ClipboardImage", function()
    ...
    before_each(function()
        package.loaded["tend.ui.clipboard_image"] = nil
        ClipboardImage = require("tend.ui.clipboard_image")
    ...
    --- @param platform tend.ui.ClipboardImage.Platform
