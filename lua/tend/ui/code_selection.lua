...
--- @class tend.ui.CodeSelection
--- @field _selections tend.Selection[]
--- @field _bufnr integer the same buffer number as the ChatWidget's code selection buffer
--- @field _on_change fun(codeSelection: tend.ui.CodeSelection)
local CodeSelection = {}
CodeSelection.__index = CodeSelection

--- @param bufnr integer The code selection buffer number from ChatWidget
--- @param on_change fun(codeSelection: tend.ui.CodeSelection) Callback to trigger when selection list changes (e.g., update header)
--- @return tend.ui.CodeSelection
