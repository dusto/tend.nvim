...
describe("diff_preview", function()
    describe("show_diff", function()
        ...
        it("creates suggestion buffer with real text for new files", function()
            ...
            -- Buffer should have _tend_suggestion_for set
            assert.equal(test_path, vim.b[bufnr]._tend_suggestion_for)
        ...
        it(
            ...
            function()
                ...
                local bufnr = vim.fn.bufnr(test_path)
                if bufnr ~= -1 then
                    assert.is_nil(vim.b[bufnr]._tend_suggestion_for)
                end
            end
        )
    ...
    describe("clear_diff", function()
        ...
        describe("set and revert modifiable buffer option", function()
            it("restores modifiable state after clearing diff", function()
                ...
                vim.b[bufnr]._tend_prev_modifiable = true
                ...
                assert.is_nil(vim.b[bufnr]._tend_prev_modifiable)
            ...
            it(
                ...
                function()
                    ...
                    vim.b[bufnr]._tend_prev_modifiable = false
                    vim.bo[bufnr].modifiable = false
        ...
        it("clears only highlights on suggestion buffer acceptance", function()
            ...
            vim.b[bufnr]._tend_suggestion_for = "/tmp/new.lua"
            ...
            -- Add diff highlights
            local NS_DIFF = vim.api.nvim_create_namespace("tend_diff_preview")
        ...
        it("deletes suggestion buffer on rejection", function()
            ...
            vim.b[bufnr]._tend_suggestion_for = "/tmp/rejected.lua"
