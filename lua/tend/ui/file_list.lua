...
--- @class tend.ui.FileList
--- @field _files string[]
--- @field _bufnr integer the same buffer number as the ChatWidget's files buffer
--- @field _on_change fun(fileList: tend.ui.FileList)
local FileList = {}
FileList.__index = FileList

--- @param bufnr integer The files buffer number from ChatWidget
--- @param on_change fun(fileList: tend.ui.FileList) Callback to trigger when file list changes (e.g., update header)
--- @return tend.ui.FileList
