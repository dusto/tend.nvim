...
--- @class tend.ui.FloatingMessage
local M = {}

--- @class tend.ui.FloatingMessage.ShowOpts
--- @field body string[] Lines to display in the window
--- @field title? string Window title (default: " Tend.nvim ")
...
--- @param opts tend.ui.FloatingMessage.ShowOpts
