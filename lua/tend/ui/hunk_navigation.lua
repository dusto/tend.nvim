...
--- @class tend.ui.HunkNavigation
local M = {}

--- Namespace for diff preview extmarks
M.NS_DIFF = vim.api.nvim_create_namespace("tend_diff_preview")
...
--- @class tend.ui.HunkNavigation.State
...
--- @type table<number, tend.ui.HunkNavigation.State>
local buffer_state = {}

--- Get or initialize state for buffer
--- @param bufnr number
--- @return tend.ui.HunkNavigation.State
...
function M.setup_keymaps(bufnr)
    ...
    end, { desc = "Go to next hunk - Tend DiffPreview" })

    BufHelpers.keymap_set(bufnr, "n", keymaps.prev_hunk, function()
        M.navigate_prev(bufnr)
    end, { desc = "Go to previous hunk - Tend DiffPreview" })
end
