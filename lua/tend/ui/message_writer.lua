local ToolCallDiff = require("tend.ui.tool_call_diff")
local BufHelpers = require("tend.utils.buf_helpers")
local Config = require("tend.config")
local DiffHighlighter = require("tend.utils.diff_highlighter")
local Fold = require("tend.ui.tool_call_fold")
local JsonFormat = require("tend.utils.json_format")
...
local NS_THINKING = vim.api.nvim_create_namespace("tend_thinking")
...
--- @class tend.ui.MessageWriter.HighlightRange
...
--- @class tend.ui.MessageWriter.ToolCallDiff
--- @field new string[]
--- @field old string[]
...
--- @field permission? tend.ui.MessageWriter.PermissionState
--- @field _rendered_button_count? integer Rendered button-row count; lags `permission` state until the next `repaint_status_row`.

--- @class tend.ui.MessageWriter
--- @field bufnr integer
--- @field tool_call_blocks table<string, tend.ui.MessageWriter.ToolCallBlock>
...
--- @param bufnr integer
--- @return tend.ui.MessageWriter instance
...
--- @param tool_call_block tend.ui.MessageWriter.ToolCallBlock
...
--- @return tend.ui.MessageWriter.HighlightRange[] highlight_ranges Array of highlight range specifications (relative to returned lines)
function MessageWriter:_prepare_block_lines(tool_call_block)
    ...
    --- @type tend.ui.MessageWriter.HighlightRange[]
...
--- @param state tend.ui.MessageWriter.PermissionState|nil nil to clear
...
--- @param highlight_ranges tend.ui.MessageWriter.HighlightRange[] Diff highlight ranges
...
--- @param highlight_ranges tend.ui.MessageWriter.HighlightRange[]
...
--- @class tend.ui.MessageWriter.StatusSegment
--- @field [1] integer start_col 0-indexed inclusive
--- @field [2] integer end_col 0-indexed exclusive
--- @field [3] string hl_group

--- @class tend.ui.MessageWriter.PermissionSection
--- @field button_lines string[]
--- @field button_segments_per_line tend.ui.MessageWriter.StatusSegment[][]
--- @field status_text string
--- @field status_segments tend.ui.MessageWriter.StatusSegment[]

--- @param tracker tend.ui.MessageWriter.ToolCallBlock
--- @return tend.ui.MessageWriter.PermissionSection section
function MessageWriter:_build_permission_section(tracker)
    ...
    --- @type tend.ui.MessageWriter.PermissionSection
    local section = {
        button_lines = {},
    ...
    --- @param line string
    --- @param segments tend.ui.MessageWriter.StatusSegment[]
...
--- @param tracker tend.ui.MessageWriter.ToolCallBlock
--- @return string text
--- @return tend.ui.MessageWriter.StatusSegment[] segments
function MessageWriter:_build_status_word(tracker)
    ...
    --- @type tend.ui.MessageWriter.StatusSegment[]
    local segments = {
...
--- @param section tend.ui.MessageWriter.PermissionSection
