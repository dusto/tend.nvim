...
describe("tend.ui.MessageWriter", function()
    --- @type tend.ui.MessageWriter
    local MessageWriter
    --- @type number
    local bufnr
    --- @type number
    ...
    local function block_end_row(tool_call_id)
        ...
        local NS = vim.api.nvim_create_namespace("tend_tool_blocks")
    ...
    local function comment_highlight_rows()
        local ns = vim.api.nvim_create_namespace("tend_diff_highlights")
        local extmarks =
    ...
    describe("_check_auto_scroll", function()
        ...
        it(
            ...
            function()
                ...
                --- @cast tracker tend.ui.MessageWriter.ToolCallBlock
    ...
    describe("status row", function()
        ...
        for _, case in ipairs({
            {
                index = 1,
                focused_hl = "TendPermissionButtonAllow",
                unfocused_hl = "TendPermissionButtonReject",
                label = "allow",
            },
            {
                index = 2,
                focused_hl = "TendPermissionButtonReject",
                unfocused_hl = "TendPermissionButtonAllow",
                label = "reject",
            },
        }) do
            it(
                ...
                function()
                    ...
                    assert.equal(
                        1,
                        count_hl_marks(marks, "TendPermissionButtonInactive")
                    )
                end
            )
        end
        ...
        describe("_build_permission_section button rows", function()
            --- @param id string
            --- @param state { is_focused: boolean, focused_button_index?: integer, sorted_options?: table[] }
            --- @return tend.ui.MessageWriter.PermissionSection
            ...
            for _, case in ipairs({
                {
                    index = 1,
                    focused_hl = "TendPermissionButtonAllow",
                    unfocused_hl = "TendPermissionButtonInactive",
                    label = "allow",
                },
                {
                    index = 2,
            ...
            it(
                ...
                function()
                    ...
                    for _, i in ipairs({ 1, 3 }) do
                        local segs = section.button_segments_per_line[i]
                        assert.equal(1, #segs)
                        assert.equal("TendPermissionButtonInactive", segs[1][3])
                    end
                end
            )
            ...
            it(
                ...
                function()
                    ...
                    local ns =
                        vim.api.nvim_create_namespace("tend_status_footer")
    ...
    describe("replay_history_messages", function()
        ...
        it("handles thought chunk messages with highlighting", function()
            ...
            assert.equal("TendThinking", details.hl_group)
    ...
    describe("thinking block highlighting", function()
        ...
        it("creates a new extmark for thought after tool call block", function()
            ...
            local ns = vim.api.nvim_create_namespace("tend_thinking")
