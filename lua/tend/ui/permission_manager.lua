...
--- @field pending table<string, tend.ui.PermissionManager.PermissionRequest> Pending requests keyed by tool_call_id
...
--- @param message_writer tend.ui.MessageWriter
--- @return tend.ui.PermissionManager
...
function PermissionManager:add_request(request, callback)
    ...
    --- @type tend.ui.PermissionManager.PermissionRequest
    local pending_req = {
...
--- @param pending tend.ui.PermissionManager.PermissionRequest
--- @protected
