...
describe("tend.ui.PermissionManager", function()
    --- @type tend.ui.MessageWriter
    local MessageWriter
    --- @type tend.ui.PermissionManager
    ...
    --- @param opts { options?: tend.wire.PermissionOption[] }|nil
    --- @return tend.wire.RequestPermission
    ...
    before_each(function()
        ...
        PermissionManager = require("tend.ui.permission_manager")
