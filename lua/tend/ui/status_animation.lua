...
--- @type table<tend.Theme.SpinnerState, number>
local TIMING = {
    generating = 200,
    thinking = 600,
    searching = 600,
...
--- @class tend.ui.StatusAnimation
--- @field _bufnr number Buffer number where animation is rendered
--- @field _state? tend.Theme.SpinnerState Current animation state
...
--- @param bufnr number
--- @return tend.ui.StatusAnimation
