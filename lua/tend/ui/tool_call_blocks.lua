--- @class tend.ui.ToolCallBlocks
local ToolCallBlocks = {}

ToolCallBlocks.NS_TOOL_BLOCKS =
    vim.api.nvim_create_namespace("tend_tool_blocks")
...
--- @class tend.ui.ToolCallBlocks.Range
--- @field start_row integer
--- @field end_row integer

--- @param bufnr integer
--- @param row integer
--- @return tend.ui.ToolCallBlocks.Range|nil range
function ToolCallBlocks.block_range_at_row(bufnr, row)
    ...
    --- @type tend.ui.ToolCallBlocks.Range
    local range = {
        start_row = start_row,
        end_row = end_row,
    }
