--- @class tend.ui.ToolCallDiff.DiffBlock
--- @field start_line integer
--- @field end_line integer
--- @field old_lines string[]
--- @field new_lines string[]

--- @class tend.ui.ToolCallDiff.ChangedPair
...
--- @class tend.ui.ToolCallDiff.FilteredLines
--- @field old_lines string[] Filtered old lines (only changed)
--- @field new_lines string[] Filtered new lines (only changed)
--- @field pairs tend.ui.ToolCallDiff.ChangedPair[] Paired changed lines with indices

--- @class tend.ui.ToolCallDiff.ExtractOpts
--- @field path string
...
--- @class tend.ui.ToolCallDiff
local M = {}

local TextMatcher = require("tend.utils.text_matcher")
...
--- @param opts tend.ui.ToolCallDiff.ExtractOpts
--- @return tend.ui.ToolCallDiff.DiffBlock[] diff_blocks
function M.extract_diff_blocks(opts)
    --- @type tend.ui.ToolCallDiff.DiffBlock[]
    local diff_blocks = {}
...
--- @param diff_block tend.ui.ToolCallDiff.DiffBlock
--- @param hunk integer[]
--- @return tend.ui.ToolCallDiff.DiffBlock
...
--- @param diff_blocks tend.ui.ToolCallDiff.DiffBlock[]
--- @return tend.ui.ToolCallDiff.DiffBlock[]
...
--- @param result tend.ui.ToolCallDiff.FilteredLines
...
--- @param new_lines string[]
--- @return tend.ui.ToolCallDiff.FilteredLines
function M.filter_unchanged_lines(old_lines, new_lines)
    --- @type tend.ui.ToolCallDiff.FilteredLines
...
--- Newline-terminated content pre-split into lines (with vim.split) carries a
--- trailing "" from the final \n. Strip it to match Neovim buffer representation
...
--- @return tend.ui.ToolCallDiff.DiffBlock[]|nil blocks Array of diff blocks or nil if no match
...
--- @return tend.ui.ToolCallDiff.DiffBlock[] diff_blocks Array of diff blocks (empty if no matches)
