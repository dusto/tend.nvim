...
--- @class tend.ui.ToolCallFold
local Fold = {}

--- @class tend.ui.ToolCallFold.ShouldFoldOpts
--- @field bufnr integer
...
--- @param opts tend.ui.ToolCallFold.ShouldFoldOpts
--- @return boolean should_fold
...
local FOLDTEXT_EXPR = "v:lua.require'tend.ui.tool_call_fold'.foldtext()"
