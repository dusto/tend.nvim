...
describe("tend.ui.ToolCallFold", function()
    --- @type integer
    local bufnr
    --- @type integer
    local winid
    ...
    describe("should_fold", function()
        ...
        --- @class (partial) tend.ui.ToolCallFold.ShouldFoldOptsOverride: tend.ui.ToolCallFold.ShouldFoldOpts

        --- @param overrides tend.ui.ToolCallFold.ShouldFoldOptsOverride|nil
        --- @return tend.ui.ToolCallFold.ShouldFoldOpts opts
        local function should_fold_opts(overrides)
            --- @type tend.ui.ToolCallFold.ShouldFoldOpts
            local opts = {
                bufnr = bufnr,
                start_row = 0,
                end_row = 0,
            ...
            return vim.tbl_extend("force", opts, overrides or {}) --[[@as tend.ui.ToolCallFold.ShouldFoldOpts]]
        end
    ...
    describe("setup_window", function()
        it("applies manual fold options to the window", function()
            ...
            assert.equal(
                ...
                "v:lua.require'tend.ui.tool_call_fold'.foldtext()"
            )
        end)
