...
--- @param config tend.UserConfig
--- @param user_config tend.PartialUserConfig
--- @return tend.UserConfig Config the static Config table with user's config merged into it
