...
--- @class tend.utils.TextMatcher.PrefixMatch
...
--- @param original_lines string[]
--- @param target_lines string[]
--- @return tend.utils.TextMatcher.PrefixMatch[] matches
...
--- @return tend.utils.TextMatcher.PrefixMatch[]
function M._try_find_prefix_boundary_matches(
    ...
    --- @type tend.utils.TextMatcher.PrefixMatch[]
    local matches = {}
